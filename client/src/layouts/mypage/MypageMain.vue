...
export default {
  ...
  methods: {
    ...
    getBuyCounts() {
      this.$axios
        .post(`${this.$store.getters.ServerUrl}/mypage/getBuyCounts`, {
          USER_KEY: this.getUserKey()
        })
        .then((result) => {
          // console.log(result.data);
    ...
    getSellCounts() {
      this.$axios
        .post(`${this.$store.getters.ServerUrl}/mypage/getSellCounts`, {
          USER_KEY: this.getUserKey()
        })
        .then((result) => {
          // console.log(result.data);
    ...
    getSimpleFavoriteList() {
      this.$axios
        .post(this.$store.getters.ServerUrl + '/mypage/getSimpleFavoriteList', {
          USER_KEY: this.getUserKey()
        })
        .then((result) => {
          //console.log(result.data);
