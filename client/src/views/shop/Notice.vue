<template>
  ...
  mdi-account
                  ...
                  <div class="mt-2">
                    <div>
                      <p @click="detailOnOff('1')">배송 기간 안내</p>
                      <ul v-show="isStatusOn1">
                        <li>
                          <p> FEVE는 최대한 빠르게 모든 상품을 배송하기 위해 노력하고 있습니다. 
                            배송 시간은 판매자가 검수를 위하여 상품을 검수센터로 보내는 속도에 따라 차이가 있습니다.</p>
                          <p>[일반 구매]</p>
                          <p>거래가 체결된 시점부터 48시간(일요일•공휴일 제외) 내에 판매자가 상품을 발송해야 하며, 
                            통상적으로 발송 후 1-2일 내에 FEVE 검수센터에 도착합니다.</p>
                          <p> - 검수센터에 도착한 상품은 입고 완료 후 3영업일 이내에 검수를 진행합니다. 검수 합격시 배송을 준비합니다.</p>
                          <p> * 상품 종류 및 상태에 따라 검수 소요 시간은 상이할 수 있으며, 
                            구매의사 확인에 해당할 경우 구매자와 상담 진행으로 인해 지연이 발생할 수 있습니다.</p>
                          <p> - 검수센터 출고는 매 영업일에 진행하고 있으며, 출고 마감시간은 오후 5시입니다. 
                            출고 마감시간 이후 검수 완료건은 운송장번호는 입력되지만 다음 영업일에 출고됩니다</p>
                        </li>
                      </ul>
                    </div>
                    <div>
                      <p @click="detailOnOff('2')">검수 안내</p>
                      <ul v-show="isStatusOn2">
                        <li>
                          ...
                          <p> * 검수 합격: FEVE 검수택(Tag)이 부착되어 배송을 준비함</p>
                    ...
                    <div>
                      <p @click="detailOnOff('3')">구매 환불/취소/교환 안내</p>
                      <ul v-show="isStatusOn3">
                        <li>
                          FEVE 익명 거래를 기반으로 판매자가 판매하는 상품을 구매자가 실시간으로 구매하여 거래를 체결합니다.
                        </li>
                        <li>
                         - 단순 변심이나 실수에 의한 취소/교환/반품이 불가능합니다. 상품을 원하지 않으시는 경우 언제든지 FEVE 재판매를 하실 수 있습니다.
                        </li>
                        <li>
                          - 상품 수령 후, 이상이 있는 경우 FEVE 고객센터로 문의해주시기 바랍니다.
                        </li>
                      </ul>
                    </div>
                    <div>
...
export default{
    ...
    methods:{
        detailOnOff(arg){
            if(arg==='1')
                this.isStatusOn1 = !this.isStatusOn1;
            else if(arg==='2')
                this.isStatusOn2 = !this.isStatusOn2;
            else
                this.isStatusOn3 = !this.isStatusOn3;
        }
    }
}
</script>