    ...
    <main class="profile-page">
      <section class="relative py-16 bg-blueGray-200 mt-24">
        <div class="container">
          ...
          >
            <div
              class="w-full flex flex-wrap items-center mt-5 mb-5 px-6 mx-auto"
            >
                ...
                <div class="w-full xl:w-6/12 mb-12 xl:mb-0 px-4 mt-12">
                  <div class="w-full">
                    <div class="text-blueGray-800">
                      ...
                      <p class="text-sm mb-1; text-gray-900">
                        {{ PRODUCT_DESC }}
                      </p>
                    </div>
                    <hr />
                    <div class="flex mt-3 pt-3">
                      <div style="width: 50%; float: left">
                        <span class="text-left" style="width:50% float:left"
                          >최근거래가</span
                        >
                      </div>
                      <div style="width: 50%; float: right; text-align: right">
                        <b
                          class="text-right recent_price"
                    ...
                    <div>
                      <div class="mt-3">
                        <v-btn
                          x-large
                          dark
                          style="background: #ef6253; width: 49%; height: 70px"
                          class="mr-1 mt-3"
                          @click="goBuy"
                        >
                    ...
                    <div class="mt-2">
                      <div style="float: left">
                        <img
                          :src="box"
                          alt="..."
                          class="w-13 h-13 rounded-full border-2 border-blueGray-50 shadow"
                        />
                      </div>
                      <div>
                    ...
                    <div class="mt-2">
                      <div>
                        <shop-card-line-chart
                          v-if="this.CHART_PRICES.length != 0"
...
export default {
  ...
  methods: {
    getView: function () {
      ...
      this.$axios
        .get(
          `${this.$store.getters.ServerUrl}/shop/shopview/` + this.PRODUCT_KEY
        )
        .then(function (res) {
          ...
          vm.PRODUCT_BRAND =
            res.data[0].PRODUCT_BRAND == 'LE' ? '레고' : '베어브릭';
    ...
    goLike: function () {
      ...
      if (this.user_key == null) {
        ...
        this.$axios
          .post(
            `${this.$store.getters.ServerUrl}/shop/shopview/` +
              this.PRODUCT_KEY +
              '/goLike',
      ...
      this.$axios
        ...
        .then(function (res) {
          ...
          if (res.data.length === 0) {
            ...
            vm.RECENT_PRICE =
              res.data[0].SELL_PRICE.toLocaleString('ko-KR') + '원';
            for (let i = 0; i < res.data.length; i++) {
              vm.PRICES = res.data;
              vm.CHART_PRICES[i] = res.data[i].SELL_PRICE;
              vm.CHART_DATES[i] = res.data[i].SELL_EDATE.substring(0, 10);
              vm.PRICES[i].SELL_PRICE =
                res.data[i].SELL_PRICE.toLocaleString('ko-KR') + '원';
      ...
      this.$axios
        ...
        .then(function (res) {
          ...
          if (res.data.length != 0) {
            ...
            for (let i = 0; i < res.data.length; i++) {
              vm.arr2[i].BUY_PRICE =
                res.data[i].BUY_PRICE.toLocaleString('ko-KR') + '원';
