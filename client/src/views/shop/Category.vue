...
<div class="w-full">
    ...
    <div class="border-b pb-4">
        ...
        <div>
            <ul class="pl-0">
                <li  class="text-sm">
                    <span  @click="getValue($event)">
                    <input type="radio" name="depth1" id="lego" value="3,4,5" v-model="cate">
                    <label for="lego" class="ml-1" @click="showMenu1">레고</label>
                    </span>
                    <ul id="legoMenu" v-if="show1">
                        <li >
                            <a href="#" @click="getValue($event)">
                                <input type="radio" name="depth1" id="architecture" value="3" v-model="cate" >
                                <label for="architecture" class="ml-1">아키텍처</label>
                            </a>
                        </li>
                        <li >
                            <a href="#" @click="getValue($event)">
                                <input type="radio" name="depth1" id="character" value="4" v-model="cate" >
                                <label for="character" class="ml-1">캐릭터</label>
                            </a>
                        </li>
                        <li >
                            <a href="#" @click="getValue($event)">
                                <input type="radio" name="depth1" id="vehicle" value="5" v-model="cate" >
                ...
                <li  class="text-sm">
                    <a href="#"  @click="getValue($event)">
                    <input type="radio" name="depth1" id="bb" value="6,7,8,9" v-model="cate">
                    <label for="bb" class="ml-1" @click="showMenu2">베어브릭</label>
                    </a>
                    <ul  v-if="show2" id="bearMenu" >
                        <li >
                            <a href="#"  @click="getValue($event)">
                                <input type="radio" name="depth1" id="fr" value="6" v-model="cate">
                                <label for="fr" class="ml-1">프리사이즈</label>
                            </a>
                        </li>
                        <li >
                            <a href="#" @click="getValue($event)" >
                                <input type="radio" name="depth1" id="100" value="7" v-model="cate" >
                                <label for="100" class="ml-1">100%</label>
                            </a>
                        </li>
                        <li >
                            <a href="#" @click="getValue($event)">
                                <input type="radio" name="depth1" id="200" value="8" v-model="cate" >
                                <label for="200" class="ml-1">200%</label>
                            </a>
                        </li>
                         <li >
                            <a href="#" @click="getValue($event)">
                                <input type="radio" name="depth1" id="1000" value="9" v-model="cate" >
  ...
  <div  class="border-b py-4">
    <div>
        ...
        <div class="py-4">
            <ul class="pl-0">
                <li  class="text-sm">
                    <a href="#"  @click="getPrice($event)">
                    <input type="radio" name="depth1" id="all" value="all" v-model="price">
                    <label for="all" class="ml-1" @click="showMenu3">모든가격</label>
                    </a>
                    <ul  v-if="show3" id="priceMenu" >
                        <li >
                            <a href="#" @click="getPrice($event)">
                                <input type="radio" name="depth1" id="10" value="10" v-model="price" >
                                <label for="10" class="ml-1">10만원 미만</label>
                            </a>
                        </li>
                        <li >
                            <a href="#" @click="getPrice($event)">
                                <input type="radio"  name="depth1" id="30" value="30" v-model="price" >
                                <label for="30" class="ml-1">10만원-30만원이하</label>
                            </a>
                        </li>
                        <li >
                            <a href="#" @click="getPrice($event)">
                                <input type="radio" name="depth1" id="50" value="50" v-model="price" >
                                <label for="50" class="ml-1">30만원-50만원 이하</label>
                            </a>
                        </li>
                        <li >
                            <a href="#" @click="getPrice($event)">
                                <input type="radio" name="depth1" id="up" value="above" v-model="price" >
