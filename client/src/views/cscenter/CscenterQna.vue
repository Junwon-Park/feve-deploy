              ...
              <div class="mt-10 py-10 border-t border-blueGray-200 text-center">
                <div class="flex flex-wrap justify-center">
                  <div class="w-full mb-12 px-4">
                    <div class="container">
                      <div
                        class="w-full mb-12 xl:mb-0 px-4 mt-12"
...
export default {
  ...
  methods: {
    startend(start, end, reqpage) {
      ...
      this.$axios
        .post(
          `${this.$store.getters.ServerUrl}/cscenter/cscenterInsert/cscenter`,
          {
  ...
  created() {
    let that = this;
    this.$axios
      .get(`${this.$store.getters.ServerUrl}/cscenter/cscenterInsert/totalCnt`)
      .then(function (res) {
