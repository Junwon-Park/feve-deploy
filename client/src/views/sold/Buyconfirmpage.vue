              ...
              <ul class="flex rounded-tr p-5 items-center px-4">
                ...
                <li class="text-center flex-1">
                  ...
                  <span class="inline-block text-2xl text-right" v-else
                    >{{ max[0].buy_price.toLocaleString('ko-KR') }}원</span
                  >
                </li>
              </ul>
              <div class="relative p-5" style="width: 100%; margin: auto">
                <v-card :elevation="0">
                  ...
                  >
                    ...
                    <v-tab href="#tab-1" style="width: 50%"> 구매 입찰 </v-tab>

                    <v-tab href="#tab-2" style="width: 50%"> 즉시 구매 </v-tab>
                  </v-tabs>
                        ...
                        >
                          ...
                          <dd class="text-sm">
                            <input
                              ...
                              autocomplete="off"
                              placeholder="희망가 입력"
                              v-model="buy.buy_price"
                              @input="
                                (e) =>
                                  (buy.buy_price = changeNum(e.target.value))
                              "
                            />
                    ...
                    <v-tab-item :value="'tab-2'">
                      <v-card flat>
                        <dl
                          ...
                          style="border-bottom: 2px solid #ebebeb"
                        >
                          <dt class="text-s" v-if="hasMinPrice === 1">
                            즉시 구매가
                          </dt>
...
export default {
  ...
  methods: {
    formSubmit() {
      ...
      let vs = this;
      this.$axios
        .post(`${this.$store.getters.ServerUrl}/buy/proc`, {
