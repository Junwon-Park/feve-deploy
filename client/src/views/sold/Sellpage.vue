<template>
  <div>
    <main class="profile-page">
      <section
        class="relative py-16 bg-blueGray-200 mt-12"
        ...
        <div class="container mx-auto px-4">
          ...
          >
            <div class="px-6">
              ...
              <h6
                class="text-3xl font-semibold leading-normal mb-2 text-blueGray-700 mb-2 text-center m-3"
              >
                판매하시기 전에 꼭 확인하세요!!
              </h6>
            </div>
                ...
                <ul>
                  ...
                  >
                    <div class="flex items-center no-underline">
                      ...
                      >
                        <p class="text-sm">
                          <strong>판매하실 상품 맞으신가요?</strong>
                        </p>

                        <p class="mt-1 text-xs ml-auto">
                          상품 이미지 모델번호 출시일 상품명 사이즈 한 번 더
                          확인했습니다.
                        </p>
                      </div>
                  ...
                  >
                    <div class="flex items-center no-underline">
                      ...
                      >
                        <p class="text-sm">
                          <strong
                            >제조사에서 불량으로 인정하지 않는 기준은 하자로
                            판단하지 않습니다</strong
                          >
                        </p>

                        <p class="mt-1 text-xs ml-auto">
                          박스/패키치와 상품 컨디션에 민감하시다면 검수 기준을
                          반드시 확인하시기 바랍니다.
                        </p>
                      </div>
                      <div class="ml-auto relative">
                  ...
                  >
                    <div class="flex items-center no-underline">
                      ...
                      >
                        <p class="text-sm">
                          <strong
                            >패키지(포장) 개봉 검수에 대한 주의사항을
                            확인합니다</strong
                          >
                        </p>

                        <p class="mt-1 text-xs ml-auto">
                          검수 과정 중 밀봉 및 실링이 모두 개봉되어 패키지로
                          포장되어 발송됩니다.
                        </p>
                      </div>
                      <div class="ml-auto relative">
