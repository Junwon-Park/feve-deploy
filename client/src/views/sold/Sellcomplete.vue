            ...
            <div>
              <div class="px-6 text-center py-12">
                ...
                <div class="mt-8 mb-10">
                  <a
                    href="https://localhost:3000/mypage"
...
export default {
  ...
  updated() {
    this.$axios
      .post(`${this.$store.getters.ServerUrl}/buy/update`, {
        user_key: JSON.parse(localStorage.getItem('userKey')),
        buyer_key: this.buy[this.buy.length - 1].buy_key
      })
      .then(function (res) {
