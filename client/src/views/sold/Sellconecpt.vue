<template>
  <div>
    <main class="profile-page">
      ...
      <section
        class="relative py-16 bg-blueGray-200 border-bottom: 2px solid rgb(235, 235, 235);"
      >
          ...
          >
                        ...
                        <div>
                          ...
                          >
                            <div
                              ...
                              style="line-height: 17px; letter-spacing: -0.15px"
                            >
                              <dt
                                class="text-sm"
                                style="
                    ...
                    <div class="pt-2">
                      ...
                      >
                        <dl style="justify-between items-center">
                          <dt
                            class="text-sm"
                            style="font-weight: 700; letter-spacing: -0.01px"
                          >
                            정산 금액
                          </dt>
                          <dd
                          ...
                          >
                            <span class="text-lg">{{
                              buy[0].buy_price.toLocaleString('ko-KR')
                            }}</span>
            ...
            <div class="flex flex-wrap items-center mt-5 mb-5 px-6">
              <div class="container m-3">
                <ul>
                  <li
                    style="list-style:none border-top:none"
                    class="border-b-2 m-4"
                  >
                    <div class="flex items-center no-underline">
                      ...
                      >
                        ...
                        <p class="mt-1 text-xs ml-auto">
                          앱 알림 해제, 알림톡 차단, 전화번호 변경 후 미등록
                          시에는 거래 진행 상태 알림을 받을 수 없으며 이로 인한
                          거래 실패는 판매자의 책임입니다.
                        </p>
                      </div>
                  ...
                  >
                    <div class="flex items-center no-underline">
                      ...
                      >
                        <p class="text-sm">
                          <strong
                            >검수 기준과 페널티 및 이용 정책을 다시 한번
                            확인하였습니다.</strong
                          >
                        </p>

                        <p class="mt-1 text-xs ml-auto">
                          이용정책 위반 시, 판매 금액의 최대 15.0%의 페널티가
                          부과됩니다. 페널티 회피 시 이후 거래가 제한되며 별도
                  ...
                  >
                    <div class="flex items-center no-underline">
                      ...
                      >
                        <p class="text-sm">
                          <strong
                            >feve 최신 이용정책을 모두 확인하였으며 구매를
                            계속합니다</strong
                          >
                        </p>

                        <p class="mt-1 text-xs ml-auto">
                          안전한 거래를 위해 반드시 숙지해야 할
                          미입고,페널티,부정거래 등의 이용정책을 확인했습니다
                        </p>
                      </div>
                      <div class="ml-auto relative">
                        <input
                  ...
                  >
                    <div class="flex items-center no-underline">
                      ...
                      >
                        <p class="text-sm">
                          <strong
                            >거래 체결시 48시간에 FEVE로 정보를
                            발송해야합니다.</strong
                          >
                        </p>

                        <p class="mt-1 text-xs ml-auto">
                          착불 배송 시 판매 금액에서 차감 정산하며, 미정산 시
                          별도 고지없이 해당 금액을 결제 시도할 수 있습니다.
                        </p>
                      </div>
                      <div class="ml-auto relative">
                        <input
...
export default {
  ...
  mounted() {
    ...
    this.$axios
      .post(`${this.$store.getters.ServerUrl}/buy/comp/user`, {
