  ...
  methods: {
    ...
    follow() {
      ...
      if (this.userInfo.USER_KEY != this.user_key) {
        this.$axios
          .post(`${this.$store.getters.ServerUrl}/style/follow`, {
    ...
    unfollow() {
      let that = this;
      this.$axios
        .post(`${this.$store.getters.ServerUrl}/style/follow/unfollow`, {
          follower_id: this.user_key,
          following_id: this.$route.params.USER_KEY
        })
        .then(() => {
    ...
    followCount() {
      ...
      this.$axios
        .post(`${this.$store.getters.ServerUrl}/style/follow/isfollow`, {
          follower_id: this.user_key,
          following_id: this.$route.params.USER_KEY
        })
        .then((res) => {
