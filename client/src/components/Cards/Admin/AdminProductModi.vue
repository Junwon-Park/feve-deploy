  ...
  <v-row justify="center" class="mt-2">
    ...
    >
      <v-card>
          ...
          <v-container>
            <v-row>
              ...
              <v-col cols="12" sm="6" md="6">
                ...
                >
                  <option
                    v-for="(brand, idx) in product_get_brand"
                    :key="idx"
              ...
              <v-col cols="12" sm="6" md="6">
                ...
                >
                  <option
                    v-for="(cate, idx) in product_get_cate"
                    :key="idx"
        ...
        <v-card-actions>
          <v-spacer></v-spacer>
          <v-btn color="blue darken-1" text @click="$emit('sendDialog')">
            취소
          </v-btn>
          <v-btn color="blue darken-1" text @click="updateModifiedList">
            저장
          </v-btn>
        </v-card-actions>
      </v-card>
