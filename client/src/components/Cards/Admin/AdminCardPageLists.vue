<template>
  ...
  >
    ...
    <Pagination :pageSize="pageSize" @onPageChanged="onPageChanged" />
  </div>
</template>
...
export default {
  ...
  methods: {
    sendItems(recP, recM) {
      ...
      this.$axios
        .post(`${this.$store.getters.ServerUrl}/admin/loadproduct/one`, {
    ...
    sendDeleteItem(recP, recM) {
      ...
      this.$axios
        .post(`${this.$store.getters.ServerUrl}/admin/deleteProduct`, {
          sendProductKey: that.receivedProductKey,
          sendMnum: that.receivedMnum
        })
        .then(function (res) {
    ...
    sendUndoDeleteItem(recP, recM) {
      ...
      this.$axios
        .post(`${this.$store.getters.ServerUrl}/admin/deleteProduct/undo`, {
          sendProductKey: that.receivedProductKey,
          sendMnum: that.receivedMnum
        })
        .then(function (res) {
    ...
    updateList(recPk, recN, recM, recL, recP, recD, recO, recB, recC) {
      ...
      (that.brandStatus = recB),
        ...
        this.$axios
          .post(`${this.$store.getters.ServerUrl}/admin/updateProduct`, {
