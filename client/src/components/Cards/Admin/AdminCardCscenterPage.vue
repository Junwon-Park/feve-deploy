    ...
    <div class="rounded-t mb-0 px-4 py-3 border-0">
      <div class="flex flex-wrap items-center">
        <div class="relative w-full px-4 max-w-full flex-grow flex-1">
          <h3 class="font-semibold text-base text-blueGray-700">문의 내역</h3>
        </div>
      </div>
    </div>
...
export default {
  ...
  methods: {
    ...
    sendItems(recC, recU, recUk) {
      ...
      this.$axios
        .post(`${this.$store.getters.ServerUrl}/admin/cscenter/one`, {
    ...
    updateList(newS) {
      ...
      this.$axios
        .post(`${this.$store.getters.ServerUrl}/admin/updateCscenter`, {
          sendCscenterKey: that.receivedCscenterKey,
